...
collapse (sum) investimento n_progetti ///
         ...
         (first) den_comune den_provincia cod_provincia cod_regione den_regione, ///
         by(com anno)
...
save "coesione_collapsed_com.dta", replace

use "coesione_collapsed_com.dta", clear
...
save "coesione_final.dta", replace

* ============================================================================
* MAIN ECONOMETRIC MODELS
* ============================================================================

use "coesione_final.dta", clear
...
mi estimate: xtreg psq_index_std ln_investimento n_progetti, fe cluster(prov)
...
mi estimate: xtreg spec_bounded ln_investimento, fe cluster(com)
mi estimate: xtreg diff_bounded ln_investimento, fe cluster(com)
mi estimate: xtreg irreg_bounded ln_investimento, fe cluster(com)
